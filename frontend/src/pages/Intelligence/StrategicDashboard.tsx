...
export default function StrategicDashboard() {
  ...
  if (loading) return <div className="p-10 text-center">Carregando inteligência estratégica...</div>;
    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white border border-gray-200 rounded-xl overflow-hidden shadow-sm">
          <div className="p-4 border-b bg-gray-50 font-semibold flex items-center gap-2">
